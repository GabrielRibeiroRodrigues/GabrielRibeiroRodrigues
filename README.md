...
🧠 Especialista em Inteligência Artificial e Visão Computacional (YOLO), aplicando tecnologia para resolver problemas complexos.

🐝 Desenvolvedor do projeto Smart Hive (Monitoramento Inteligente de Colmeias) e da plataforma Agrobase.

🐳 Entusiasta de Docker e infraestrutura otimizada para garantir consistência em produção.

🛠️ Tecnologias e Ferramentas
🖥️ Desenvolvimento Fullstack & IA
<p>
...
<p>Participação e destaque em competições de algoritmos e resolução de problemas complexos.</p>
